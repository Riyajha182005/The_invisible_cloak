...
import numpy as np ## mathmatical library for image handling 
...
while cap.isOpened():
    ...
    if ret:
        ...
        u_red=np.array([10,255,255]) ## mnkjhiuognjir  miuwenvow9 nf4tnv nerruenf, nfiweui  vvkkniet
        ...
        ## substituting  the red portion from the background image 
        ...
        ## if cloak is not present show the current imaage
